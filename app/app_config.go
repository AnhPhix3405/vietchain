...
import (
	...
	identitymodulev1 "VietChain/api/vietchain/identity/module"
	_ "VietChain/x/identity/module" // import for side-effects
	identitymoduletypes "VietChain/x/identity/types"
